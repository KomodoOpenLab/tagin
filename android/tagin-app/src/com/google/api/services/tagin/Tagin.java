...
public class Tagin extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Urns {
     ...
     * @return the request
     */
    public Neighbours neighbours(java.lang.String urn) throws java.io.IOException {
      Neighbours result = new Neighbours(urn);
      initialize(result);
      return result;
    }
    ...
    public class Neighbours extends TaginRequest<com.google.api.services.tagin.model.URNCollection> {
       ...
       * @since 1.13
       */
      protected Neighbours(java.lang.String urn) {

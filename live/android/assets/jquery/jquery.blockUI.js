...
function install(el, opts) {
    ...
    // layer2 is the overlay layer which has opacity and a wait cursor ...adding my own stuff here to modify the opacity and background colour for the overlay, also chaning the cursor to default instead of wait!!!
    ...
    var lyr2 = $('<div class="blockUI blockOverlay" style="z-index:'+ z++ +';display:block;cursor:default;background-color:#000;opacity:0.2;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
